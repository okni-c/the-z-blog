...
export default function Nav() {
    const [, setDarkToggle] = useState<boolean | undefined>();
    ...
    useEffect(() => {
        ...
        if (localStorage.getItem('z-blog-theme') === 'true') {
            setIsChecked(true)
        } else {
            setIsChecked(false)
        }
    ...
    useEffect(() => {
        ...
        if (isChecked === true) {
            ...
            setDarkToggle(true)
            localStorage.setItem('z-blog-theme', 'true');
            return
        }
        ...
        if (isChecked === false) {
            ...
            setDarkToggle(false)
            localStorage.setItem('z-blog-theme', 'false');
            return
        }
                        ...
                        <div className="flex items-center justify-center">
                            <label htmlFor="toggleB" className="flex items-center cursor-pointer">
                                <div className="relative">
                                    ...
                                    <div className="block dark:bg-neutral-800 bg-neutral-100 dark:bg-opacity-80 bg-opacity-80 drop-shadow-xl w-8 md:w-14 h-8 rounded-full"></div>
