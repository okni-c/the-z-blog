...
const PostPage: NextPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Z-Chronicles | {post.data?.title}</title>
            ...
            <main>
                <header className="flex flex-col sm:flex-row sm:justify-between sm:mb-5 sm:mt-2 mt-2 mb-3">
                    <h1 className="flex items-center justify-center md:justify-start">{post.data?.title}</h1>
                ...
                <section className="max-w-[1000px] w-full mx-auto">
                    <Image src={post.data?.thumbnail || ''} width={1000} height={500} className="rounded-xl mx-auto aspect-video object-cover drop-shadow-lg hover:xl:scale-105 hover:xl:my-4 ease-in-out duration-150" alt="Blog article thumbnail"  />
