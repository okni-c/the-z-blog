        ...
        <>
            ...
            <main>
                ...
                <div className="flex items-start">
                    {/* Left Post data */}
                    <form className="m-0 pr-5">
                        <input type='radio' id='new-post' className='opacity-0 fixed w-0' name="1" defaultChecked />
                        <label htmlFor='new-post' className="border-green-600 border-2 rounded-xl my-2 py-2 px-4 hover:border-green-400 hover:cursor-pointer whitespace-nowrap checked:bg-green-600 flex items-center" onClick={() => sendData(null)}><h5 className="m-0 flex items-center dark:text-white text-black">
