    ...
    <>
      ...
      <main className="flex flex-col justify-start">
        <div className="my-8 md:my-14 text-center">
          <Image src="/logo.jpg" width={150} height={500} className="mx-auto aspect-video object-contain m-0 p-0 md:motion-safe:animate-bounce ease-in-out" alt='red car icon' />
